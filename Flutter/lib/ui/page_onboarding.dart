...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  final List<Widget> _pages = [
    IntroPage("assets/onboard_1.png","Lets Get Started! ", "Welcome to Qudio Health!! \n \n Making healthcare secure, safe & swift."),
    IntroPage("assets/onboard_2.png","Compact ", "All your health reports at one place. \n \n Managing your health records was never easier"),
    IntroPage("assets/onboard_3.png","Efficient ", "No more waiting. No discrepancy. \n \n We value your privacy!"),
  ];
