...
import 'package:flutter_ui_collections/widgets/dropdown.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  FocusNode _profFocusNode =  FocusNode();
  ...
  BoxField _profWidget() {
    return BoxField(
        controller: _emailController,
        focusNode: _emailFocusNode,
        hintText: "Enter Account Tpye",
        lableText: "Account",
        obscureText: false,
        onSaved: (String val) {
          _email = val;
        ...
        onFieldSubmitted: (String value) {
          FocusScope.of(context).requestFocus(_profFocusNode);
        },
        icon: Icons.work,
        iconColor: colorCurve);
  }
